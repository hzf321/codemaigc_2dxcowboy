...
function Login_View:yunAnim()
    local login_bg = self.root.login_bg
    local yun_1 = login_bg:getChildren()[1] 
    local yun_2 = login_bg:getChildren()[2] 

    yun_1:runAction(cc.MoveTo:create(120,cc.p(800,360)))
    yun_2:runAction(cc.MoveTo:create(120,cc.p(750,360)))
end
