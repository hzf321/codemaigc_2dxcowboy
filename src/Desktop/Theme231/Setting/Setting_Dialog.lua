...
function Setting_Dialog:onBtnServiceClicked()
    bole.playSounds("click")
    local url = "https://sites.google.com/view/pixietreasurestermsofservice/halaman-muka"
...
function Setting_Dialog:onBtnPrivacyClicked()
    bole.playSounds("click")
    local url = "https://sites.google.com/view/pixietreasuresprivacypolicy/halaman-muka"
	cc.Application:getInstance():openURL(url)
