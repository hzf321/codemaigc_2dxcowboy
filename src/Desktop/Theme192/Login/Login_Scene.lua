...
function Login_Scene:ctor(enterlobby_callback)
    ...
    bole.playBGM("hallbg")
	self:initLayout()
    cc.SpriteFrameCache:getInstance():addSpriteFrames("theme_desktop/theme192/lobby/packs/lobby.plist")
    cc.SpriteFrameCache:getInstance():addSpriteFrames("theme_desktop/theme192/header_footer/packs/footer.plist")
    cc.SpriteFrameCache:getInstance():addSpriteFrames("theme_desktop/theme192/header_footer/packs/header.plist")
