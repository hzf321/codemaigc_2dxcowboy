...
function Setting_Dialog:onBtnServiceClicked()
    bole.playSounds("click")
    local url = "https://sites.google.com/view/solar-apollo-terms-of-service/halaman-muka"
...
function Setting_Dialog:onBtnPrivacyClicked()
    bole.playSounds("click")
    local url = "https://sites.google.com/view/solar-apollo-privacy-policy/halaman-muka"
	cc.Application:getInstance():openURL(url)
