...
function Setting_Dialog:showThemeSetting()
	...
	if contrl_node then
        ...
        contrl_node:setPosition(cc.p(pos.x  - 400, pos.y  +  130))
...
function Setting_Dialog:onBtnServiceClicked()
    bole.playSounds("click")   
    local url = "https://sites.google.com/view/forest-spin-terms-of-service/halaman-muka"
...
function Setting_Dialog:onBtnPrivacyClicked()
    bole.playSounds("click")
    local url = "https://sites.google.com/view/forest-spin-privacy-policy/halaman-muka"
	cc.Application:getInstance():openURL(url)
