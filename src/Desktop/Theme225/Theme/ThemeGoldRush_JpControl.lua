...
ThemeGoldRush_JpControl = class("ThemeGoldRush_JpControl", ThemeBaseJackpotControl)
local cls = ThemeGoldRush_JpControl

require (bole.getDesktopFilePath("Theme/ThemeGoldRush_JpView")) 
...
function cls:initLayout( jpRoot )
	self.jpView = ThemeGoldRush_JpView.new(self, jpRoot)
...
function cls:playJPArriveAnim(jpType)
	self.jpView:playJPArriveAnim(jpType)
end
