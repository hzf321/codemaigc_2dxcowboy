...
function Setting_Dialog:onBtnServiceClicked()
    bole.playSounds("click")
    local url = "https://sites.google.com/view/stellar-roaming-terms-of-servi/halaman-muka"
...
function Setting_Dialog:onBtnPrivacyClicked()
    bole.playSounds("click")
    local url = "https://sites.google.com/view/stellarroamingprivacypolicy/halaman-muka"
	cc.Application:getInstance():openURL(url)
