...
-- local jpView = require("Themes/MightyCash/MightyC_JpView")
local jpView = require (bole.getDesktopFilePath("Theme/MightyC_JpView")) 
  
local cls = class("MightyC_JpViewControl", ThemeBaseJackpotControl)
...
function cls:initLayout( jpRoot, jpTip )
	self.jpView = jpView.new(self, jpRoot, jpTip)
