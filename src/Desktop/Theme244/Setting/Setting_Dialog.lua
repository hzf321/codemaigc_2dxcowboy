...
function Setting_Dialog:onBtnServiceClicked()
    bole.playSounds("click")
    local url = "https://sites.google.com/view/safarislotstermsofservice/%E9%A6%96%E9%A1%B5"
...
function Setting_Dialog:onBtnPrivacyClicked()
    bole.playSounds("click")
    local url = "https://sites.google.com/view/safari-slots-privacy-policy/%E9%A6%96%E9%A1%B5"
	cc.Application:getInstance():openURL(url)
